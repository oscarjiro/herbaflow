...
from app.pipeline.stages import stage1, stage2, stage3, stage4, stage5
...
RUNNABLE_STAGES: tuple[int, ...] = (1, 2, 3, 4, 5)  # extended as stages land
NEEDS_APPROVAL: frozenset[int] = frozenset({1, 2, 3, 4, 5})  # guided checkpoints

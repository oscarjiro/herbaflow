...
DEFAULT_INPUT = Path("../01_extract/out/stg_plants.csv")
DEFAULT_OUTPUT_DIR = Path("out")
DEFAULT_OUTPUT_FILE = "normalized_plants.csv"
DEFAULT_REPORT_FILE = "normalize_taxonomy_report.txt"
DEFAULT_LOG_FILE = "normalize_taxonomy.log"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to staged input CSV (default: 01_extract/out/stg_plants.csv)",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=DEFAULT_OUTPUT_DIR,
        help="Directory where normalized outputs will be written (default: 02_normalize_taxonomy/out)",
    )
    parser.add_argument(
        "--output-file",
        type=str,
...
def main() -> int:
    ...
    logging.info("Starting 02_normalize_taxonomy")

...
DEFAULT_INPUT = Path("../03_match_gbif/out/gbif_matches.csv")
DEFAULT_OUTPUT_DIR = Path("out")
DEFAULT_ACCEPTED_FILE = "accepted_plants.csv"
DEFAULT_REVIEW_FILE = "review_plants.csv"
DEFAULT_REJECTED_FILE = "rejected_plants.csv"
DEFAULT_MANUALLY_ACCEPTED_REVIEW_FILE = "manually_accepted_review_plants.csv"
DEFAULT_REPORT_FILE = "build_canonical_report.txt"
DEFAULT_LOG_FILE = "build_canonical.log"
...
ACCEPT_CONFIDENCE_THRESHOLD = 90.0
REVIEW_CONFIDENCE_THRESHOLD = 70.0
HIGHERRANK_REVIEW_THRESHOLD = 80.0
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to GBIF match output CSV (default: 03_match_gbif/out/gbif_matches.csv)",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=DEFAULT_OUTPUT_DIR,
        help="Directory where canonical outputs will be written (default: 04_build_canonical/out)",
    )
    parser.add_argument(
        "--accepted-file",
        type=str,
        default=DEFAULT_ACCEPTED_FILE,
...
def write_report(
    ...
    lines = [
        ...
        f"- review: plausible but not strong enough for automatic acceptance, or higher-rank match needing manual confirmation",
...
def main() -> int:
    ...
    logging.info("Starting 04_build_canonical part 1")

...
DEFAULT_PLANTS = Path("../04_build_canonical/out/plants.csv")
DEFAULT_ALIASES = Path("../04_build_canonical/out/plant_aliases.csv")
DEFAULT_OUTPUT_DIR = Path("out")
DEFAULT_LOG_FILE = "validate.log"
DEFAULT_REPORT_CSV = "validation_report.csv"
DEFAULT_REPORT_JSON = "validation_report.json"
DEFAULT_VALIDATED_PLANTS = "plants.csv"
DEFAULT_VALIDATED_ALIASES = "plant_aliases.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to plants.csv (default: 04_build_canonical/out/plants.csv)",
    )
    parser.add_argument(
        "--aliases",
        type=Path,
        default=DEFAULT_ALIASES,
        help="Path to plant_aliases.csv (default: 04_build_canonical/out/plant_aliases.csv)",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=DEFAULT_OUTPUT_DIR,
        help="Directory where validation outputs will be written (default: 05_validate/out)",
    )
    parser.add_argument(
        "--report-csv",
        type=str,
    ...
    parser.add_argument(
        "--validated-plants",
        type=str,
        default=DEFAULT_VALIDATED_PLANTS,
        help="Filename for validated plants CSV (default: plants.csv)",
    )
    parser.add_argument(
        "--validated-aliases",
        type=str,
        default=DEFAULT_VALIDATED_ALIASES,
...
def main() -> int:
    ...
    logging.info("Starting 05_validate")

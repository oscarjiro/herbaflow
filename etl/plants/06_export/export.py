...
DEFAULT_INPUT_DIR = Path("../05_validate/out")
DEFAULT_OUTPUT_DIR = Path("out")
DEFAULT_LOG_FILE = "export.log"
DEFAULT_MANIFEST_FILE = "export_manifest.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Folder containing validated plants.csv and plant_aliases.csv (default: 05_validate/out)",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=DEFAULT_OUTPUT_DIR,
        help="Folder to write export files into (default: 06_export/out)",
    )
    parser.add_argument(
        "--plants-file",
        type=str,
...
def main() -> int:
    ...
    logging.info("Starting 06_export")

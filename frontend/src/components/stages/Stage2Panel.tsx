...
const columns: ColumnDef<AdmeRow>[] = [
  ...
  },
  {
    ...
    header: 'MW (Da)',
    sortable: true,
    render: (_v, r) => (r as AdmeCompoundResult).molecular_weight != null ? (r as AdmeCompoundResult).molecular_weight!.toFixed(2) : '—',
  },
  {
    key: 'logp',
    header: 'LogP',
    sortable: true,
    render: (_v, r) => (r as AdmeCompoundResult).logp != null ? (r as AdmeCompoundResult).logp!.toFixed(2) : '—',
  },
  {
    key: 'tpsa',
    header: 'TPSA (Å²)',
    sortable: true,
    render: (_v, r) => (r as AdmeCompoundResult).tpsa != null ? (r as AdmeCompoundResult).tpsa!.toFixed(1) : '—',
  },
  {
    key: 'hbond_donors',
    header: 'HBD',
    sortable: true,
    render: (_v, r) => (r as AdmeCompoundResult).hbond_donors != null ? String((r as AdmeCompoundResult).hbond_donors) : '—',
  },
  {
    key: 'hbond_acceptors',
    header: 'HBA',
    sortable: true,
    render: (_v, r) => (r as AdmeCompoundResult).hbond_acceptors != null ? String((r as AdmeCompoundResult).hbond_acceptors) : '—',
  },
  {
    key: 'np_likeness_score',
    header: 'NP-score',
    sortable: true,
    render: (_v, r) => (r as AdmeCompoundResult).np_likeness_score != null ? (r as AdmeCompoundResult).np_likeness_score!.toFixed(2) : '—',
  },
  {
    key: 'adme_pass',
    header: 'Result',

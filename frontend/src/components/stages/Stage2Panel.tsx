...
const columns: ColumnDef<AdmeRow>[] = [
  ...
  },
  {
    ...
    header: 'MW (Da)',
    sortable: true,
    render: (_, r) => r.molecular_weight != null ? r.molecular_weight.toFixed(2) : '—',
  },
  {
    key: 'logp',
    header: 'LogP',
    sortable: true,
    render: (_, r) => r.logp != null ? r.logp.toFixed(2) : '—',
  },
  {
    key: 'tpsa',
    header: 'TPSA (Å²)',
    sortable: true,
    render: (_, r) => r.tpsa != null ? r.tpsa.toFixed(1) : '—',
  },
  {
    key: 'hbond_donors',
    header: 'HBD',
    sortable: true,
    render: (_, r) => r.hbond_donors != null ? String(r.hbond_donors) : '—',
  },
  {
    key: 'hbond_acceptors',
    header: 'HBA',
    sortable: true,
    render: (_, r) => r.hbond_acceptors != null ? String(r.hbond_acceptors) : '—',
  },
  {
    key: 'np_likeness_score',
    header: 'NP-score',
    sortable: true,
    render: (_, r) => r.np_likeness_score != null ? r.np_likeness_score.toFixed(2) : '—',
  },
  {
    key: 'adme_pass',
    header: 'Result',

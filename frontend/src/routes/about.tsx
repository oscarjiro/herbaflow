        ...
        <Reveal>
          ...
          <div className="ab-dropcap">
            <p>
              ...
              wider view. A medicinal plant carries many bioactive compounds at once, each able to
              act on several human proteins, and those proteins sit inside the larger network that
              drives a disease. Herbaflow maps that network: it links a plant&apos;s compounds to
              the human proteins they act on (their targets), and links those targets to the disease
              you want to study. The result lets you read a plant as a system, not a single
              ingredient.
            </p>
          </div>
        </Reveal>
      ...
      <section className="ab-section" id="sec-02">
        <Reveal>
          ...
          <p>
            ...
            repetitive computational work from start to finish, in one place, with every step open
            to review, so the time goes into the thinking instead of the plumbing.
          </p>
        </Reveal>
      </section>
        ...
        <Reveal>
          ...
          <div className="ab-specsheet">
            ...
            <div className="ab-spec-row">
              ...
              <p>
                Every association carries a link back to the database it came from, so any result
          ...
          <GlassSurface tier="raised" className="ab-box">
            <div className="ab-timeline">
              <div className="ab-tl-item">
                ...
                <p>
                  Additional bioactivity and disease databases, to widen and cross-check the
                  evidence.
                </p>
              </div>
              <div className="ab-tl-item">
                  ...
                  <CollapsibleContent className="ab-cite-content">
                    ...
                    <div className="ab-cite-text">
                      ...
                      <span className="ab-ital">
                        Rancang Bangun Herbaflow Platform Web Network Pharmacology dengan Studi
                        Kasus Tumbuhan Obat Indonesia.
                      </span>{" "}
